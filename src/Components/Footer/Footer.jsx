      ...
      <footer>
        <section className="footer">
          <div className="box-container">
            <div className="box">
              ...
              <div className="share">
                ...
                <a href="https://www.instagram.com/safi.bro/?hl=en">
            ...
            <div className="box">
              ...
              <a href="mailto:grocerystore@gamil.com" className="links">
                <i>
                  <MdOutlineMarkEmailRead />
                </i>
                grocerystore@gamil.com
              </a>
          ...
          <div className="credit">
            Created By <span>M.S Developer </span> | All Right Reserved
          </div>
        </section>
      </footer>
    </>
